...
| 模型 | 任务 | 标准输入 | 来源 | 当前状态 |
| --- | --- | --- | --- | --- |
| [YOLOv5s](models/perception/object_detection/yolov5s/README.md) | Perception / Object detection | 640×640 RGB | Qualcomm / Ultralytics | 板端已验证 |
| [ViT-Base Patch16 224](models/perception/image_classification/vit_base_patch16_224/README.md) | Perception / Image classification | 224×224 RGB | Qualcomm | 环境建设中 |
