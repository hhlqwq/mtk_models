...
export MTK_BOARD_OPEN_MODELS_ROOT="${MTK_BOARD_ROOT}/open_models"
export MTK_BOARD_DATASETS_ROOT="${MTK_BOARD_ROOT}/datasets"
export MTK_BOARD_MODELZOO_ROOT="${MTK_BOARD_ROOT}/MTK_G720_DLA"
