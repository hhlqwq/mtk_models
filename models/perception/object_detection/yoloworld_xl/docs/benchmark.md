...
| --- | ---: | ---: |
| mean | `8343.526 ms` | `3729.547 ms` |
| min | `8336.634 ms` | `3717.839 ms` |
| max | `8347.116 ms` | `3740.412 ms` |
| P50 | `8346.828 ms` | `3729.813 ms` |
| P90 | `8347.059 ms` | `3739.668 ms` |
| P95 | `8347.088 ms` | `3740.040 ms` |
| 峰值 RSS | `832456 KiB` | `1082536 KiB` |

混合路径相对本轮 CPU mean 加速 `2.2371×`.单图 profiling 记录 20 个 Neuron 节点事件和
384 个 CPU 节点事件,因此该结果不能表述为全模型 NPU.
