...
python -m pip check
python -c "import cv2, mtk_converter, numpy, torch, torchvision; import ultralytics.yolo; print('[VERIFY] numpy:', numpy.__version__); print('[VERIFY] opencv:', cv2.__version__); print('[VERIFY] torch:', torch.__version__); print('[VERIFY] torchvision:', torchvision.__version__); print('[VERIFY] mtk_converter:', mtk_converter.__version__)"
