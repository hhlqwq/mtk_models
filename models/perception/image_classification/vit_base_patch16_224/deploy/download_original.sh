...
readonly ASSET_URL="https://qaihub-public-assets.s3.us-west-2.amazonaws.com/qai-hub-models/models/vit/releases/v0.61.0/vit-onnx-float.zip"
readonly ARCHIVE_PATH="${MODEL_ROOT}/original/vit-onnx-float.zip"

echo "[1/3] 下载 Qualcomm ViT FP32 ONNX 归档。"
