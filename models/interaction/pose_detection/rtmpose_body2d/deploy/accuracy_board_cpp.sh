...
readonly BOARD_MODEL_DIR="${BOARD_ROOT}/rtmpose_body2d/model"
...
readonly BOARD_OUTPUT="${BOARD_ROOT}/rtmpose_body2d/eval/${RUN_ID}"
readonly BOARD_SMOKE="${BOARD_OUTPUT}/smoke"
